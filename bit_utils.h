...
void bits_split64(uint64_t input, uint64_t *left,
                  uint64_t *right);

__device__ __host__

void bits_split(uint64_t input, uint64_t *left,
...
void bits_copy(uint64_t src, uint64_t *dst, int src_offset,
...
void bits_print_grouped(uint64_t val, int group_size,
                        int length);
...
uint64_t bits_cycle_right(uint64_t val, int shift,
                          int size);

__device__ __host__

uint64_t bits_permutate(uint64_t key, int *permutation,
...
uint64_t bits_cycle_left(uint64_t val, int shift,
                         int size) {
    uint64_t tmp = 0;
